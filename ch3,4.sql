...
SELECT * FROM sample31 ORDER BY a, b;

SELECT * FROM sample31 ORDER BY a ASC, b DESC;

SELECT * FROM sample33 LIMIT 3;

SELECT * FROM sample33 ODER BY no DESC LIMIT 3;

SELECT * FROM sample33 LIMIT 3 OFFSET 0;

SELECT * FROM sample33 LIMIT 3 OFFSET 3;

SELECT *, price * quatity FROM sample34;

SELECT *, price * quatity AS amount FROM sample34;
...
INSERT INTO sample41 (no) VALUES (3);
